...
- To view our full results, please [click here](notebooks/full_results.ipynb).
- To view the thematic content analaysis of the free-text answers, please [click here](notebooks/content_analysis.ipynb).
:::
...
In addition to the current practices and attitudes, a further key motivation for this survey was to better understand how the use and adoption of the Gemini Principles.
