...
with st.form("survey_form"):
    ...
    sector = st.selectbox(
        ...
        "Manufacturing", "Maritime", "Media", "Mining", "National Government", 
        "Nuclear Energy", "Oil and Gas", "Place Leadership", "Rail", "Renewable Energy", 
        "Smart Cities", "Supply Chain and Logistics", "Technology", "Telecommunications", 
        "Transport", "Utilities", "Waste and Recycling", "Water"],
...
if submitted:
    ...
    if conn:
        ...
        data = {
            ...
            "location": location,
            "role": role,
            "responsibilities": ', '.join(primary_responsibilities)  # Joining list into a string
        }
