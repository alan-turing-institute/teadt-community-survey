...
setup_spinner(css_bottom="30px", font_size="2em")
...
with st.spinner("waiting"):
    ...
    with st.container():
        ethical_framework_existence = (
            question_generator.generate_streamlit_element(
                ...
                options=questions["ethical_framework_existence"].get(
                    "options"
                ),
            ...
            if (
                ...
                framework_description = (
                    question_generator.generate_streamlit_element(
                        ...
                        options=questions["framework_description"].get(
                            "options"
                        ),
                ...
                framework_development = (
                    question_generator.generate_streamlit_element(
                        ...
                        options=questions["framework_development"].get(
                            "options"
                        ),
        ...
        value_of_guiding_principles = (
            question_generator.generate_streamlit_element(
                ...
                options=questions["value_of_guiding_principles"].get(
                    "options"
                ),
    ...
    with st.container():
        ...
        Digital Built
         Britain](https://www.cdbb.cam.ac.uk/DFTG/GeminiPrinciples)
        ...
        relevance_good = question_generator.generate_streamlit_element(
            ...
            help="Must be used to deliver "
            "genuine public benefit in perpetuity.",
        )
        ...
        relevance_insight = question_generator.generate_streamlit_element(
            ...
            help="Must provide determinable insight "
        ...
        if relevance_federation != "Not Relevant":
            challenge_federation = (
                question_generator.generate_streamlit_element(
                    "Federation",
                    "likert_col",
                    options=questions["challenge_in_application"].get(
                        "options"
                    ),
        ...
        vars_challenging = [
            locals()[var] for var in vars_challenging if var in locals()
        ]
