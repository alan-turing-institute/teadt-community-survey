...
st.markdown("""
Assurance of your digital twin involves more than just implementing the right technologies and processes.
It also requires demonstrating to all stakeholders that your actions are backed by evidence and clearly support broader goals of trustworthiness and ethics.
This is especially relevant in the context of connected digital twins, when data is shared across multiple organizations.
This section of our survey assesses your capabilities and potential needs for demonstrating and communicating your project's assurance strategies effectively to both internal teams and external partners.
""")

# Begin a form for the survey inputs
with st.form("evidence_based_assurance_form"):
    # Display each question using the utility function to handle different input types
...
# Actions to take after the form is submitted, such as saving responses or navigating
if submitted:
