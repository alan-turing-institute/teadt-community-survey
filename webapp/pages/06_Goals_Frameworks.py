...
st.markdown("Diving deeper into the frameworks and principles guiding the ethical and trustworthy development of digital twins ")
...
with container:
    ...
    ethics_framework = st.radio(
        "3.1 Does your organisation have an established definition or framework for 'trustworthy' and 'ethical' digital twins?",
        ["Yes", "No","I don't know"],index=None
    )

    if ethics_framework=="Yes":
        ethics_definition = st.text_area("3.1b If yes, please describe your organisation's definition or framework for 'trustworthy' digital twins.") 

        framework_development = st.radio("3.1c How was this definition or framework developed?",
                                         ["Consensus-based process (e.g. collaborative efforts of industry consortia)", "Internal governance process","Developed by an external consultant", "Reused existing framework","Adapted existing framework"], index=None) 
    
        framework_url = st.text_area("3.1d If your framework is publicly available, please provide a link.") 

# Question 3.2
value_ethical_principles = st.slider(
    "3.2 How valuable do you find ethical principles in general, such as the Gemini principles?",
    1, 5, key='3_1'
)

# Question 3.2b
if value_ethical_principles < 3:
    value_low_explain = st.text_area("Please explain why you currently rate the value of guiding principles as low?")
...
# Question 3.5
main_challenges = st.text_area("For those rated very difficult or extremely difficult to operationalize, what are the main challenges you face?")
