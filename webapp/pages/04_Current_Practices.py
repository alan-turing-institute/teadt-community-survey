...
if st.session_state.show_def:
    ...
    *Assurance is the process of measuring, evaluating and communicating something about a system or product (e.g. a digital twin). 
    (Following the definition of the Department of Science, Innovation, and Technology's "Introduction to AI Assurance") 
    This can include a range of activities such as conducting a system audit, validating a dataset, carrying out training around ethical practices or achieving certified compliance with a specific standard.*
    :::
    """,
...
if st.session_state.continue_clicked:
    ...
    with container:
        ...
        for tag in ["assurance_mechanisms", "assured_properties", "asset_data_sharing","partner_trust_difficulty","partner_trust_challenges","reliance_on_evidence"]:
    ...
    if st.button("Submit & See Results"):
        ...
        if client:
            ...
            data = {
                ...
                "governance_requirements": ", ".join(st.session_state["governance_requirements"]),
