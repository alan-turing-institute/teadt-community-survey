...
additional_insights = st.text_area(
    ...
    help="Your insights are valuable to us. Feel free to share any thoughts or experiences."
)
...
workshop_interest = st.checkbox(
    "I would like to join a more in-depth workshop to learn about assurance methodology & build my own assurance case under the guidance of experts.",
